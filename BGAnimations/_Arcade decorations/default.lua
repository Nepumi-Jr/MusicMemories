...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor(THEME:GetPathG("OptionRowExit","Frame")) .. {
		InitCommand=function(self) self:diffuse(Color("Orange")); self:diffusealpha(0.35); end;
	};
	LoadFont("Common Normal") .. {
		InitCommand=function(self) self:zoom(0.75); self:shadowlength(1); self:glowshift(); self:strokecolor(Color("Outline")); self:diffuse(Color("Orange")); self:diffusetopedge(Color("Yellow")); self:textglowmode('TextGlowMode_Inner'); end;
		Text="...";
