...
return Def.ActorScroller{
	...
	Def.ActorFrame{
		Def.BitmapText{
			...
			Font="Common Normal",
			Text="Scroll Item 1",
			InitCommand=function(self) self:diffuse(color("#FF0000")); end,
		},
	},
	Def.ActorFrame{
		Def.BitmapText{
			...
			Font="Common Normal",
			Text="Scroll Item 2",
			InitCommand=function(self) self:glow(color("#00FF0088")); end,
		},
	},
	Def.BitmapText{
		Name="ScrollItem3",
		Font="Common Normal",
		Text="Scroll Item 3",
		InitCommand=function(self) self:bob(); self:effectmagnitude(8,0,4); end,
	},

	-- Scroller commands
	InitCommand=function(self) self:Center(); end,
	OnCommand=function(self) self:scrollwithpadding(8,8); end,
}
