...
t[#t+1] = Def.Quad{
    ...
    OnCommand=function(self) self:decelerate(1.25); self:diffuse(color("0.75,0,0,0.75")); self:linear(7); self:diffuse(color("0,0,0,1")); self:sleep(1.25); self:linear(1); self:diffuse(color("1,0,0,1")); self:decelerate(2); self:diffuse(color("0,0,0,1")); end;
};
t[#t+1] = Def.Quad{
