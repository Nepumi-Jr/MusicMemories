local t = Def.ActorFrame{
    ...
    Def.Sprite{
        InitCommand=cmd(CenterX;y,SCREEN_CENTER_Y-100;animate,false;zoom,1.3;diffuse,color("#70421400");Load,THEME:GetCurrentThemeDirectory().."Graphics/_GraphFont/BigCount/FAIL.png");
