...
local line_on = function(self) self:zoom(0.875); self:strokecolor(color("#444444")); self:shadowcolor(color("#444444")); self:shadowlength(1); end
local section_on = function(self) self:diffuse(color("#88DDFF")); self:strokecolor(color("#446688")); self:shadowcolor(color("#446688")); self:shadowlength(1); end
local subsection_on = function(self) self:diffuse(color("#88DDFF")); self:strokecolor(color("#446688")); self:shadowcolor(color("#446688")); self:shadowlength(1); end
...
local creditScroller = Def.ActorScroller {
	...
	OnCommand = function(self) self:scrollwithpadding(item_padding_start,15); end;
}
...
return Def.ActorFrame{
	creditScroller..{
		InitCommand=function(self) self:CenterX(); self:y(SCREEN_BOTTOM-64); end,
	}
};
